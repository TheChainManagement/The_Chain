# Codex run prompt — W3 fix round 1 (paste this whole file into Codex)

You are working in the repo for The Chain (supply-chain SaaS).
Branch: codex/w3-role-spine (continue this branch; it is checked out and clean).
Task: implement the checkpoint fix list below. Full review detail is in
_reviews/2026-07-21_w3_checkpoint_claude_verdict.md if you need it.
