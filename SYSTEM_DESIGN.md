...
**The anchor-point architecture decision:** every balance mutation flows through ONE SQL primitive — `post_stock_movement()`. Future modules (W2-3 procurement, logistics, maintenance) touch stock ONLY through this kernel; a module writing `inventory_levels` or inserting `stock_movements` any other way is a defect.
